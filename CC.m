...
%%
load HRECG_seq_SSLMSWAM.mat 'Pcorr';HR1= Pcorr;
load HRECG_PD_SSLMSWAM.mat 'Pcorr';HR2= Pcorr;
load HRECG_NotchF.mat 'Pcorr';HR3= Pcorr;
L1=length(HR1);
load UHFECG_seq_SSLMSWAM.mat 'Pcorr';UHF1= Pcorr;
load UHFECG_PD_SSLMSWAM.mat 'Pcorr';UHF2= Pcorr;
load UHFECG_NotchF.mat 'Pcorr';UHF3= Pcorr;
L2=length(UHF1);
load IEGM_seq_SSLMSWAM.mat 'Pcorr';IGM1= Pcorr;
load IEGM_PD_SSLMSWAM.mat 'Pcorr';IGM2= Pcorr;
load IEGM_NotchF.mat 'Pcorr';IGM3= Pcorr;
L3=length(IGM1);
...
% title('Correlation Coefficient for All Cardiac Signals')
